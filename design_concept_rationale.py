...
"The components are shown and labelled in Figure __.")
st.image("chalk_pop_parts.png", "Figure __: The Chalk Pop parts labelled")
...
"To form this chalk, we used a grinder to reshape the chalk from a cube to a semisphere. " \
...
st.subheader("Shroud")
#shroud
st.image("shroud.png", "Figure __: The shroud")
...
st.subheader("Handle")
#handle
st.write("The handle is designed to contour with the shape of the user's hand, as shown in Figure __. ")
st.image("handle_hand.png", "Figure __: Handle contoured to hand shape")
