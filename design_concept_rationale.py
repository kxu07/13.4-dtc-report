...
"The components are shown and labelled in Figure 8.")
st.image("chalk_pop_parts.png", "Figure 8: The Chalk Pop parts labelled")
...
st.subheader("Chalk")
#chalk
st.write("The chalk, as shown in Figure 9, is semi-spherical, instead of cube shaped like it traditionally is. The chalk is two centimeters in diameter. " \
...
st.image("round_chalk.png", "Figure 9: semi-spherical chalk")


st.subheader("Shroud")
#shroud
st.write("The shroud fits around the chalk and is clear and cone-shaped, as seen in Figure 10. The purpose of the shroud is the help guide the user in using the product. " \
...
st.image("shroud.png", "Figure 10: The shroud")

st.subheader("Handle")
#handle
st.write("The handle is designed to contour with the shape of the user's hand, as shown in Figure 11. ")
st.image("handle_hand.png", "Figure 11: Handle contoured to hand shape")
