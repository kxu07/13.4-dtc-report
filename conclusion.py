...
st.write("In summary, we believe our product meets the requirements we set out to accomplish. We wanted an effective, easy to use/intuitive, and safe product that would allos for even chalk application with no adverse side effects. " \
