...
figures = pd.DataFrame(
    {
        ...
        "Location": ["Executive Summary", "Introduction", "Introduction", "Introduction", "Introduction", "Introduction", "Introduction", "Design Concept and Rationale", "Design Concept and Rationale", "Design Concept and Rationale", "Design Concept and Rationale", "Appendix C: Market Research Summary",  "Appendix C: Market Research Summary",  "Appendix C: Market Research Summary",  "Appendix C: Market Research Summary", "Appendix E: Instructions for Construction", "Appendix E: Instructions for Construction", "Appendix E: Instructions for Construction", "Appendix E: Instructions for Construction", "Appendix E: Instructions for Construction", "Appendix F: Instructions for Use"]
    }
)
